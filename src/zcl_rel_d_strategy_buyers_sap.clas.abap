class ZCL_REL_D_STRATEGY_BUYERS_SAP definition
  public
...
CLASS ZCL_REL_D_STRATEGY_BUYERS_SAP IMPLEMENTATION.


  METHOD /bobf/if_frw_determination~execute.
    CASE is_ctx-det_key.
      WHEN zif_rel_bo_strategy_c=>sc_determination-buyers_sap-descriptions.
  ...
  METHOD descriptions.
    DATA lt_data TYPE zrel_bo_i_strategy_buyers_sap.
